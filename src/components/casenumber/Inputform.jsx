import { Box, Button, HStack, Input, Text, VStack, Image } from '@chakra-ui/react';
    ...
    <Box mx="auto" p={4} border={'1px solid #BF987466'} width="100%">
      <VStack width="100%" spacing={4} textAlign="center">
        ...
        <Box width="100%" textAlign="left">
          <Text fontSize="sm" fontWeight="bold">Case Type</Text>
          <Input 
            name="case" 
        ...
        <HStack width="100%" spacing={4} flexDirection={{ base: "column", md: "row" }}>
          <Box width="100%" textAlign="left">
            <Text fontSize="sm" fontWeight="bold">Case Number</Text>
            <Input
              name="caseNumber" 
          ...
          <Box width="100%" textAlign="left">
            <Text fontSize="sm" fontWeight="bold">Case Year</Text>
            <Input 
              name="caseYear" 
        ...
        {/* CAPTCHA */}
        <Box width="100%" textAlign="left">
          <Text fontSize="sm" fontWeight="bold">Captcha</Text>
          <HStack width="100%">
